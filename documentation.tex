...
\begin{center}
    \movie[externalviewer]{\textbf{[Watch the Baseline kernel OS Demo on YouTube]}}{https://www.youtube.com/watch?v=gFLKEqt4GPs}
\end{center}
...
\centering
\vspace{2cm}
\textbf{Baseline kernel OS Lead Developer}\\
\vspace{1cm}
